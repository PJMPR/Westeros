...
namespace Westeros.Events.Data.Migrations
{
    ...
    [Migration("20181106223721_AddProfileEventsDB")]
    partial class AddProfileEventsDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Westeros.Events.Data.Model.Message", b =>
                {
                    b.HasOne("Westeros.Events.Data.Model.Profile", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("Westeros.Events.Data.Model.Profile", "Sender")
                        .WithMany()
